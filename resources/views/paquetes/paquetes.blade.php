...
@section('content')
	<h1 id="titulo">Paquetes Procesados
		@if ($flagFechaFin)
	...
	<script type="text/javascript">
	    // Script para no mostrar elementos vacios
	    if(document.getElementsByTagName('td').length === 2) {
	      document.getElementById('paquetes').style.display = 'none';
	      document.getElementById('chart').style.display = 'none';
	      document.getElementById('titulo').innerHTML = 'Paquetes Procesados';
	      document.getElementById('mensaje').innerHTML = 'Ningun paquete procesado, seleccione otra fecha';
	      alert("Ningun paquete procesado en esta fecha");
	    }
	</script>
@stop
